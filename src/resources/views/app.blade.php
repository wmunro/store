...
<html lang="en">
    <head>
        ...
        <meta name=description content="A medium sized e-commerce shopping cart made by Bill Munro and Billy Claus. Made using Laravel 5.2" />
        <meta name="keywords" content="shopping, ecommerce, store, electronics, electronics store, Billy Claus, Bill Munro, github, laravel, laravel 5, laravel 5.2" />
        <meta name="author" content="Bill Munro and Billy Claus" />
        <link rel="shortcut icon" href="{!! asset('/images/slider/fav-icon.png') !!}" />

        <title>Exciting E-commerce Store</title>
...
<body>
    ...
    <script>
        gapi.analytics.ready(function() {
            ...
            gapi.analytics.auth.authorize({
                ...
                clientid: '828448789321-j3eritemoitcskpf6m6q1367fn6ilu12.apps.googleusercontent.com'
            });
            /**
    ...
    <script>
        // your publish key
        Stripe.setPublishableKey('pk_test_evkDfXKyW9zmOZuSvasCnaTP');
        //
        jQuery(function($) {
